...
class IndexBuilder:
    def __init__(self, repo_path: str, output_dir: str = "data", collection_name: str = "repo_code", use_mock_embedding: bool = False, provider: str = None, ignore_dirs: List[str] = None):
        ...
        self.embedding_service = get_embedding_service(use_mock=use_mock_embedding, provider=provider)
